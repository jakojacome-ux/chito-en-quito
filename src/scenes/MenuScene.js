...
export default class MenuScene extends Phaser.Scene {
  ...
  drawBackground() {
    ...
    this.add.rectangle(cx, 730, GAME_WIDTH, 340, 0x000000, 0.16)
  ...
  createTitle() {
    this.add.text(GAME_WIDTH / 2, 105, 'Chito', {
    ...
    this.add.text(GAME_WIDTH / 2, 185, 'en Quito', {
      fontFamily: 'Arial Black',
      fontSize: '72px',
      color: '#28bdf6',
      stroke: '#10243a',
    ...
    this.add.text(GAME_WIDTH / 2, 265, 'Encuentra el café en el Centro Histórico', {
      fontFamily: 'Arial Black',
      fontSize: '30px',
      color: '#ffffff',
      stroke: '#3a1d12',
  ...
  createFooter() {
    this.add.text(GAME_WIDTH / 2, 845, 'Versión estable · Chito en Quito', {
      fontFamily: 'Arial Black',
      fontSize: '18px',
      color: '#fff3d6',
      stroke: '#3a1d12',
  ...
  openHowToPlay() {
    ...
    const panel = this.add.rectangle(GAME_WIDTH / 2, GAME_HEIGHT / 2, 760, 540, 0xfff4df, 0.98)
      .setStrokeStyle(6, 0xf1c24c, 1)
    panel.setDepth(101)

    const title = this.add.text(GAME_WIDTH / 2, 225, 'Cómo jugar', {
      fontFamily: 'Arial Black',
      fontSize: '48px',
      color: '#f1b52f',
      stroke: '#3a1d12',
    ...
    const instructionText = this.add.text(GAME_WIDTH / 2, 420, instructions.join('\n'), {
      fontFamily: 'Arial Black',
      fontSize: '28px',
      color: '#2e1f14',
      align: 'left',
  ...
  createModalButton(x, y, label, onClick) {
    ...
    const bg = this.add.rectangle(0, 0, 320, 70, 0xf5bf3a, 1)
